      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden text-sm">
        ...
        <div className="p-6 flex justify-between items-center border-b border-gray-100 bg-white">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-bold text-lg text-gray-900">Senarai Jurulatih</h2>
          </div>
          <button 
        ...
        <div className="p-6 border-b border-gray-100 bg-gray-50/50 space-y-4 max-w-2xl">
          <div className="flex items-center gap-4">
            <label className="w-48 text-right font-medium text-gray-700 text-xs text-nowrap">Nama Jurulatih :</label>
            <input 
              type="text" 
              value={filterNama}
          ...
          <div className="flex items-center gap-4">
            <label className="w-48 text-right font-medium text-gray-700 text-xs text-nowrap">No. KP/Pasport Jurulatih :</label>
            <input 
              type="text" 
              value={filterNoKp}
          ...
          <div className="flex items-center gap-4">
            <label className="w-48 text-right font-medium text-gray-700 text-xs text-nowrap">No. Waran/No. Jurulatih :</label>
            <input 
              type="text" 
              value={filterNoWaran}
          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden shadow-sm">
              ...
              <table className="w-full text-left border-collapse text-sm">
                <thead className="bg-gray-50 text-gray-500 uppercase text-xs font-semibold tracking-wider border-b border-gray-200">
                  <tr>
                    ...
                    <th className="px-4 py-3 border-r border-gray-100 text-center uppercase">Nama Jurulatih</th>
                    <th className="px-4 py-3 border-r border-gray-100 text-center uppercase w-48">No. KP/Pasport Jurulatih</th>
                    <th className="px-4 py-3 border-r border-gray-100 text-center uppercase w-48">No. Waran/No. Jurulatih</th>
            ...
            <div className="flex justify-center items-center py-4 bg-gray-50 gap-4 border-t border-gray-200">
               <div className="flex space-x-2 text-xs font-semibold">
                  <button className="text-gray-400 cursor-not-allowed">« Pertama</button>
                  <button className="text-gray-400 cursor-not-allowed">‹ Sebelumnya</button>
               </div>
               <div className="text-xs text-gray-500 flex items-center space-x-1">
                 <span>Halaman</span>
                 <input type="text" value="1" readOnly className="w-8 text-center border border-gray-300 rounded p-0.5" />
                 <span>dari 9</span>
                 <span className="ml-2">Jumlah Rekod : 167</span>
               </div>
               <div className="flex space-x-2 text-xs font-semibold">
                  <button className="text-action-teal hover:underline">Seterusnya ›</button>
                  <button className="text-action-teal hover:underline">Terakhir »</button>
               </div>
            </div>
          ...
          >
            ...
            <div className="px-6 py-4 flex justify-between items-center border-b border-gray-100 bg-gradient-to-r from-gray-800 to-gray-700 text-white">
              <h3 className="font-bold text-base tracking-wide">
                {editingId ? 'Ubah Jurulatih' : 'Tambah Jurulatih'}
              </h3>
              <button 
            ...
            <div className="p-6 bg-gray-50/50 space-y-4">
              <div className="flex items-center gap-4">
                <label className="w-48 text-right font-medium text-gray-700 text-sm">
                  <span className="text-alert-red">*</span>Nama Jurulatih:
                </label>
                <input 
                  type="text" 
                  value={formData.nama}
              ...
              <div className="flex items-center gap-4">
                <label className="w-48 text-right font-medium text-gray-700 text-sm">
                  <span className="text-alert-red">*</span>No. KP/Pasport Jurulatih:
                </label>
                <input 
                  type="text" 
                  value={formData.noKp}
              ...
              <div className="flex items-center gap-4">
                <label className="w-48 text-right font-medium text-gray-700 text-sm">
                  <span className="text-alert-red">*</span>No. Waran/No. Jurulatih:
                </label>
                <input 
                  type="text" 
